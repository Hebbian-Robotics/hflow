...
from hflow.ffmpeg._binary import (
    ...
    _pinned_install_dir,
    ffmpeg_filter_script_flag,
    ffmpeg_major_version,
    ffmpeg_path,
    ffmpeg_version,
    ffprobe_major_version,
    ffprobe_path,
    ffprobe_version,
)
...
def _clear_all_binary_caches() -> None:
    ...
    ffmpeg_major_version.cache_clear()
    ffmpeg_filter_script_flag.cache_clear()
    ffprobe_path.cache_clear()
    ffprobe_version.cache_clear()
    ffprobe_major_version.cache_clear()
...
def test_ffmpeg_filter_script_flag_matches_resolved_binary() -> None:
    ...
    flag = ffmpeg_filter_script_flag()
